...
<form action="{{ route('admin.admins.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12">
            ...
            <input class="form-control  @error('country_code') is-invalid error('phone_code') is-invalid @enderror @error('phone') is-invalid @enderror" type="tel" name="phone" id="phone_number" placeholder="{{ __('trans.Phone Number') }}" value="{{ old('phone') }}" required autocomplete="phone">
        ...
        <div class="col-md-6 col-sm-12">
            ...
            <input class="form-control-file" id="image" type="file" name="image" onchange="document.getElementById('image').src = window.URL.createObjectURL(this.files[0])">
        </div>
