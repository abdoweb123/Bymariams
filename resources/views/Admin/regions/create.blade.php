...
@section('content')
<form method="POST" action="{{ route('admin.regions.store') }}" enctype="multipart/form-data" data-parsley-validate novalidate>
    @csrf
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <select class="form-control" required id="country_id" name="country_id">
                <option value="0" selected hidden disabled>{{ trans('trans.Select') }}</option>
        ...
        @else
        <input type="hidden" name="country_id" id="country_id" class="form-control" value="{{ request()->country_id }}">
        @endif
        <div class="form-group col-md-6">
