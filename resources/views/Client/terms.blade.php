            ...
            <div class="d-flex {{-- justify-content-center align-items-center --}} w-100 h-100">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item h2 active" aria-current="page">{{ trans('trans.Terms and Conditions') }}</li>
                  </ol>
                </nav>
            </div>
        </div>
...
<div class="text-center">
    <img src="{{ asset(setting('terms_image')) }}" alt="Image" class="my-3 SettingImage w-100">
</div>
