...
@section('content')
    <form method="POST" action="{{ route('admin.settings.store') }}" enctype="multipart/form-data" data-parsley-validate
        novalidate>
        @csrf
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <select class="form-control" required id="valuetype" name="valuetype">
